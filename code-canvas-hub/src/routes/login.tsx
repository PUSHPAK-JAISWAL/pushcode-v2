  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center px-4 py-10">
      ...
      <div className="glass-strong w-full max-w-md p-8">
        ...
        <p className="mt-1 text-center text-sm text-muted-foreground">Sign in to continue to PushCode</p>
        ...
        <form onSubmit={submit} className="mt-8 space-y-6">
          ...
          <div>
            ...
            <input className="glass-input mt-1" type="password" required value={password}
        ...
        <p className="mt-6 text-center text-sm text-muted-foreground">
          ...
          <Link to="/register" className="text-[#d4af37] hover:underline">Sign Up</Link>
        </p>
      </div>
